...
export const ACCOUNTING_LOCALES: Record<AccountingLocaleId, AccountingLocaleConfig> = {
  ...
  JP: {
    ...
    taxConcepts: {
      ...
      certifiedInput:{ 'zh-CN': '可抵扣仕入消费税', 'zh-TW': '可抵扣仕入消費稅', en: 'Deductible Input Tax', ja: '控除対象仕入税額', ko: '공제 가능 매입 소비세', fr: 'Taxe déductible certifiée' },
      invoicedOutput:{ 'zh-CN': '已开票売上消费税', 'zh-TW': '已開票売上消費稅', en: 'Invoiced Output Tax', ja: '請求済み売上税額', ko: '발행된 매출 소비세', fr: 'Taxe collectée facturée' },
      ...
      invoiceInputLabel: { 'zh-CN': '仕入请求书数', 'zh-TW': '仕入請求書數', en: 'Purchase Invoices', ja: '仕入請求書数', ko: '매입계산서', fr: 'Factures achats' },
      invoiceOutputLabel: { 'zh-CN': '売上请求书数', 'zh-TW': '売上請求書數', en: 'Sales Invoices', ja: '売上請求書数', ko: '매출계산서', fr: 'Factures ventes' },
      ...
      invoiceTypeOutput: { 'zh-CN': '売上', 'zh-TW': '売上', en: 'Sales', ja: '売上', ko: '매출', fr: 'Vente' },
      invoiceTypeInput: { 'zh-CN': '仕入', 'zh-TW': '仕入', en: 'Purchase', ja: '仕入', ko: '매입', fr: 'Achat' },
      inventoryUnit: { 'zh-CN': '单位', 'zh-TW': '單位', en: 'units', ja: '単位', ko: '단위', fr: 'unités' },
      ...
      purchaseTotal: { 'zh-CN': '仕入含税总额', 'zh-TW': '仕入含稅總額', en: 'Purchase Total (Incl. Tax)', ja: '仕入税込合計', ko: '매입 세금포함 총액', fr: 'Total achats TTC' },
      salesTotal:    { 'zh-CN': '売上含税总额', 'zh-TW': '売上含稅總額', en: 'Sales Total (Incl. Tax)', ja: '売上税込合計', ko: '매출 세금포함 총액', fr: 'Total ventes TTC' },
  ...
  KR: {
    ...
    taxConcepts: {
      ...
      certifiedInput:{ 'zh-CN': '可抵扣매입세액', 'zh-TW': '可抵扣매입세額', en: 'Deductible Input VAT', ja: '控除対象仕入VAT', ko: '공제 가능 매입세액', fr: 'TVA déductible certifiée' },
      invoicedOutput:{ 'zh-CN': '已开票매출세액', 'zh-TW': '已開票매출세額', en: 'Invoiced Output VAT', ja: '請求済み売上VAT', ko: '발행된 매출세액', fr: 'TVA collectée facturée' },
      ...
      invoiceInputLabel: { 'zh-CN': '매입세금계산서', 'zh-TW': '매입세금계산서', en: 'Purchase Tax Invoices', ja: '仕入税金計算書', ko: '매입세금계산서', fr: 'Factures taxe achats' },
      invoiceOutputLabel: { 'zh-CN': '매출세금계산서', 'zh-TW': '매출세금계산서', en: 'Sales Tax Invoices', ja: '売上税金計算書', ko: '매출세금계산서', fr: 'Factures taxe ventes' },
      invoicePendingTax: { 'zh-CN': '待申报附加价值税', 'zh-TW': '待申報附加價值稅', en: 'Pending VAT Filing', ja: '未申告VAT', ko: '미신고 부가가치세', fr: 'TVA en attente' },
      invoiceTypeOutput: { 'zh-CN': '매출', 'zh-TW': '매출', en: 'Sales', ja: '売上', ko: '매출', fr: 'Vente' },
      invoiceTypeInput: { 'zh-CN': '매입', 'zh-TW': '매입', en: 'Purchase', ja: '仕入', ko: '매입', fr: 'Achat' },
      inventoryUnit: { 'zh-CN': '단위', 'zh-TW': '단위', en: 'units', ja: '単位', ko: '단위', fr: 'unités' },
      taxSummaryTitle:{ 'zh-CN': '附加价值税含税汇总 (对账用)', 'zh-TW': '附加價值稅含稅匯總 (對帳用)', en: 'VAT-Inclusive Summary (Reconciliation)', ja: 'VAT税込集計（照合用）', ko: '부가가치세 포함 요약 (대조용)', fr: 'Résumé TTC TVA (rapprochement)' },
      purchaseTotal: { 'zh-CN': '매입含税总额', 'zh-TW': '매입含稅總額', en: 'Purchase Total (Incl. VAT)', ja: '仕入VAT込合計', ko: '매입 세금포함 총액', fr: 'Total achats TTC' },
      salesTotal:    { 'zh-CN': '매출含税总额', 'zh-TW': '매출含稅總額', en: 'Sales Total (Incl. VAT)', ja: '売上VAT込合計', ko: '매출 세금포함 총액', fr: 'Total ventes TTC' },
      taxDifference: { 'zh-CN': '附加价值税差额', 'zh-TW': '附加價值稅差額', en: 'VAT Difference', ja: 'VAT差額', ko: '부가가치세 차액', fr: 'Différence TVA' },
    },
    dashboardSections: ['profit_loss', 'profit_margins', 'vat_summary', 'tax_inclusive_summary'],
